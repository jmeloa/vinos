...
class CepasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cepa" do
    assert_difference('Cepa.count') do
      post cepas_url, params: { cepa: { nombre_cepa: @cepa.nombre_cepa, percent: @cepa.percent } }
    end
  ...
  test "should update cepa" do
    patch cepa_url(@cepa), params: { cepa: { nombre_cepa: @cepa.nombre_cepa, percent: @cepa.percent } }
